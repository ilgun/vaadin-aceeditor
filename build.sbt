...
pomExtra in ThisBuild := <url>https://github.com/ilgun/vaadin-aceeditor</url>
  <licenses>
    <license>
  ...
  <scm>
    <url>https://github.com/ilgun/vaadin-aceeditor</url>
    <connection>scm:git@github.com:ilgun/vaadin-aceeditor.git</connection>
  </scm>
  <developers>
    <developer>
      <id>ilgun</id>
...
libraryDependencies ++= Seq(
  ...
  "com.vaadin" % "vaadin-compatibility-shared" % vaadinVersion,
