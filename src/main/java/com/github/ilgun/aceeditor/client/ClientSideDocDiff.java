...
public class ClientSideDocDiff {
	...
	public static ClientSideDocDiff fromTransportDiff(TransportDiff ad) {
		...
		JsArray<GwtTextDiff.Patch> patches = dmp.patch_fromText(ad.patchesAsString);
		MarkerSetDiff msd = MarkerSetDiff.fromTransportDiff(ad.markerSetDiff);
		
		SetDiff<AceAnnotation.RowAnnotation,TransportDoc.TransportRowAnnotation> rowAnns = ad.rowAnnDiff==null ? null :
				SetDiff.fromTransport(ad.rowAnnDiff);
		SetDiff<AceAnnotation.MarkerAnnotation,TransportDoc.TransportMarkerAnnotation> markerAnns =  ad.markerAnnDiff==null ? null :
	...
	public static ClientSideDocDiff diff(AceDoc doc1, AceDoc doc2) {
		...
		SetDiff<AceAnnotation.RowAnnotation,TransportDoc.TransportRowAnnotation> rowAnnDiff = diffRA(doc1.getRowAnnotations(), doc2.getRowAnnotations());
		SetDiff<AceAnnotation.MarkerAnnotation,TransportDoc.TransportMarkerAnnotation> markerAnnDiff = diffMA(doc1.getMarkerAnnotations(), doc2.getMarkerAnnotations());
